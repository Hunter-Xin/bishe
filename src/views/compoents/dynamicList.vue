...
.pd-info-center {
  ...
  .y-number {
    ...
    &.y-number-1 {
      ...
      animation-delay: 1s;
      background: url(../../assets/img/dynamic/info-line-01.png) no-repeat 180px
        center;
      height: 60px;
      top: 15px;
      .y-number-bg {
      ...
      .y-number-icon {
        background: url(../../assets/img/dynamic/info-icon-1.png) no-repeat 50%
          50%;
      }
    }
    &.y-number-2 {
      ...
      background: url(../../assets/img/dynamic/info-line-02.png) no-repeat 180px
        center;
      height: 60px;
      top: 70px;
      padding-left: 350px;
      ...
      .y-number-icon {
        background: url(../../assets/img/dynamic/info-icon-2.png) no-repeat 50%
          50%;
      }
    }
    &.y-number-3 {
      ...
      .y-number-icon {
        background: url(../../assets/img/dynamic/info-icon-3.png) no-repeat 50%
          50%;
      }
    }
    &.y-number-4 {
      ...
      .y-number-icon {
        background: url(../../assets/img/dynamic/info-icon-4.png) no-repeat 50%
          50%;
      }
    }
  }
